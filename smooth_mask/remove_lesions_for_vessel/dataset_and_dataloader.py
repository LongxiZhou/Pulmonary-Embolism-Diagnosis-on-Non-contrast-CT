...
import random
from smooth_mask.remove_lesions_for_vessel.prepare_dataset import apply_lesion_parallel
import time
import numpy as np
import torch
from classic_models.Unet_3D.utlis import random_flip_rotate_swap
...
def get_list_of_lesion_loc_array(lesion_difficulty_level, lesion_top_dict=None):
    ...
    if lesion_top_dict is None:
        lesion_top_dict = '/data_disk/artery_vein_project/smooth_blood_mask/lesion_simulation'
...
class SmoothMaskDataset:
    ...
    def __getitem__(self, idx):
        ...
        return self.loaded_sample_list[idx]  # float32 numpy array in [4, 128, 128, 128]
...
def check_correctness_test_dataloader():
    ...
    temp_sample_dataset_test = SmoothMaskDataset('/data_disk/artery_vein_project/smooth_blood_mask/'
                                                 'training_data/sliced_sample/256/CTA/stack_array_artery/',
    ...
    temp_dataloader_test = SmoothMaskDataloader(temp_sample_dataset_test, temp_lesion_dataset, 2, shuffle=True,
                                                ...
                                                num_test_replicate=4, num_lesion_applied=12)
...
def check_correctness_train_dataloader():
    ...
    temp_sample_dataset_train = SmoothMaskDataset('/data_disk/artery_vein_project/smooth_blood_mask/'
                                                  'training_data/sliced_sample/256/CTA/stack_array_artery/',
...
if __name__ == '__main__':
    check_correctness_train_dataloader()
