import torch
import smooth_mask.remove_lesions_for_vessel.training_iteration as train_iterations
import os
...
parameters = {
    ...
    "flip_precision": 0.92,  # reach this precision, then can flip
    "base_relative": 1.,
    ...
    "max_performance_recall": 0.95,  # force flip when recall > max_performance in recall phase
    "max_performance_precision": 0.95,  # force flip when precision > max_performance in precision phase
    ...
    "checkpoint_dir":
        "/data_disk/artery_vein_project/smooth_blood_mask/check_points/256_final_augment/",
    ...
    "list_train_data_dir": ['/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/CTA/stack_array_artery',
                            '/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/CTA/stack_array_vein',
                            '/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/non-contrast/stack_array_artery',
                            '/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/non-contrast/stack_array_vein'],

    "list_test_data_dir":  ['/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/CTA/stack_array_artery',
                            '/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
                            '256/CTA/stack_array_vein',
                            '/data_disk/artery_vein_project/smooth_blood_mask/training_data/sliced_sample/'
