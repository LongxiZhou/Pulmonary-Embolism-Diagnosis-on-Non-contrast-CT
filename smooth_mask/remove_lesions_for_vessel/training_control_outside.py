import sys
sys.path.append('/ibex/scratch/projects/c2052/longxi_platform')
import torch
...
parameters = {
    ...
    "lr": 1e-3,
    "batch_size": 4,  # number of ct in each batch
    ...
    "checkpoint_dir":
        "/ibex/scratch/projects/c2052/smooth_vessel_mask/remove_blood_lesion/check_points/256_ibex/",
    ...
    "list_train_data_dir": ['/ibex/scratch/projects/c2052/smooth_vessel_mask/remove_blood_lesion/training_data/'
                            'sliced_sample/256/CTA/stack_array_artery',
                            '/ibex/scratch/projects/c2052/smooth_vessel_mask/remove_blood_lesion/training_data/'
                            'sliced_sample/256/CTA/stack_array_vein',
                            '/ibex/scratch/projects/c2052/smooth_vessel_mask/remove_blood_lesion/training_data/'
                            'sliced_sample/256/non-contrast/stack_array_artery',
                            '/ibex/scratch/projects/c2052/smooth_vessel_mask/remove_blood_lesion/training_data/'
                            'sliced_sample/256/non-contrast/stack_array_vein'],
    ...
    "lesion_top_dict": '/ibex/scratch/projects/c2052/smooth_vessel_mask/lesion_simulation',
    "num_lesion_applied": (6, 12),
