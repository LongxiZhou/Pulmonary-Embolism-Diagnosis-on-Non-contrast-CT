...
import collections
import classic_models.Unet_3D.U_net_Model_3D as U_net_Models
import smooth_mask.get_lung_vessel_blood_region.loss_function as loss_function
import smooth_mask.get_lung_vessel_blood_region.dataset_and_dataloader as dataset_and_loader
...
def training(params):
    ...
    train_loader = dataset_and_loader.SmoothMaskDataloader(
        train_dataset, lesion_dataset, params["batch_size"], shuffle=params["shuffle"],
    ...
    test_loader = dataset_and_loader.SmoothMaskDataloader(
        test_dataset, lesion_dataset, params["batch_size"], shuffle=params["shuffle"],
        num_workers=params["num_workers"],
