...
parameters = {
    ...
    "accumulate_step": 16,  # real batch size is batch_ct * accumulate_step
    "shuffle": True,  # shuffle the before each training iteration.
    "drop_last": True,  # whether drop last incomplete batch during training
    "num_test_replicate": 1,  # the test is prepared before training, more test will have more lesion variants
    ...
    "checkpoint_dir":
        "/data_disk/artery_vein_project/extract_blood_region/check_points/256_v2_temp/",
    ...
    "sample_interval": (1, 2),  # sample_path_list = sample_path_list[sample_interval[0]:: sample_interval[1]]

    "list_train_data_dir": ['/data_disk/artery_vein_project/extract_blood_region/training_data/sliced_sample/'
                            '256_v2/CTA/stack_array_artery',
                            '/data_disk/artery_vein_project/extract_blood_region/training_data/sliced_sample/'
                            '256_v2/CTA/stack_array_vein',
                            '/data_disk/artery_vein_project/extract_blood_region/training_data/sliced_sample/'
                            '256_v2/CTA/stack_array_blood',
                            '/data_disk/artery_vein_project/extract_blood_region/training_data/sliced_sample/'
                            '256_v2/CTA/stack_array_blood_high_recall',
                            ],
