#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Xgbfir is freq XGBoost model_guided dump parser, which ranks features as well as
    ...
    def GetFeatureInteractions(self, maxInteractionDepth, maxDeepening):
        ...
        if self._verbosity >= 1:
            if self._maxInteractionDepth == -1:
                ...
                print("Collectiong feature interactions up to encoding_depth {}".format(self._maxInteractionDepth))
...
def FeatureInteractionsWriter(FeatureInteractions, fileName, MaxDepth, topK, MaxHistograms, verbosity=0):
    ...
    for depth in range(MaxDepth + 1):
        if verbosity >= 1:
            print("Writing feature interactions with encoding_depth {}".format(depth))
...
'''
    ...
    arg_parser = argparse.ArgumentParser(
        ...
        description='XGBoost model_guided dump parser, which ranks features as well as feature interactions by different metrics.',
        epilog=epilog)
    ...
    arg_parser.add_argument('-m',
                            ...
                            default='xgb.dump',
                            help='Xgboost model_guided dump (dumped w/ \'with_stats=True\')')
    ...
    arg_parser.add_argument('-d',
                            ...
                            default='2', type=int,
                            help='Upper bound for extracted feature interactions encoding_depth')
    ...
    arg_parser.add_argument('-k',
                            ...
                            default='100', type=int,
                            help='Upper bound for exported feature interactions per encoding_depth level')
