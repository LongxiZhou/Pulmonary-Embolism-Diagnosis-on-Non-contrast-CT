...
# Parameters for the entire model_guided (stem, all_file encoding_blocks, and head)
...
def alexnet_params(model_name):
    """ Map AlexNet model_guided name to parameter coefficients. """
    params_dict = {
...
def alexnet(dropout_rate, image_size, num_classes=1000):
    """ Creates freq alexnet model_guided. """
...
def get_model_params(model_name, override_params):
    """ Get the block args and global parameters for freq given model_guided """
