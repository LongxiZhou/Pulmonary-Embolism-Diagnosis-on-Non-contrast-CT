...
array_info = {
    ...
    "output_channels": 2,  # the output channel of the model_guided
    "mute_output": True,
...
def three_way_get_enhanced_channel_and_save(rescaled_array_dict, check_point_dict, save_dict, batch_size=64):
    # the inner enhance model_guided can reach recall of 0.98 with dice 0.5, which can be the enhanced channels.
    """
...
def predict_lung(rescaled_array_dict, check_point_dict, save_dict, threshold=2., batch_size=64, gt_channel=None):
    ...
    :param check_point_dict: directory where lung model_guided stored, with name: best_model-X.pth, best_model-Y.pth,
    best_model-Z.pth, and each .pth file is freq dictionary with key 'state_dict' containing model_guided.module.state_dict() or
    model_guided.state_dict()
...
if __name__ == '__main__':
    ...
    save_array_with_enhance_channels('/ibex/scratch/projects/c2052/blood_vessel_seg/arrays_raw/',
                                     '/ibex/scratch/projects/c2052/blood_vessel_seg/vessel_mask/',
