        ...
        for x in range(8, 504, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                if single:
                    ...
                    pre_five_data = data[x - 8, :, :]  # previous 5 mm is 8 slices on x-axis_list
                    pre_two_data = data[x - 3, :, :]  # previous 2 mm is 3 slices on x-axis_list
        ...
        for y in range(8, 504, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                if single:
                    ...
                    pre_five_data = data[:, y - 8, :]  # previous 5 mm is 8 slices on y-axis_list
                    pre_two_data = data[:, y - 3, :]  # previous 2 mm is 3 slices on y-axis_list
        ...
        for z in range(5, 507, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                if single:
                    ...
                    pre_five_data = data[:, :, z - 5]  # previous 5 mm is 5 slices on z-axis_list
                    pre_two_data = data[:, :, z - 2]  # previous 2 mm is 2 slices on z-axis_list
    ...
    if direction == 'X':
        for x in range(8, 504, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                current_slice_data = data[x, :, :]
                pre_one_data = data[x - 2, :, :]  # previous 1 mm is 2 slices on x-axis_list
    ...
    if direction == 'Y':
        for y in range(8, 504, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                current_slice_data = data[:, y, :]
                pre_one_data = data[:, y - 2, :]  # previous 1 mm is 2 slices on x-axis_list
    ...
    if direction == 'Z':
        for z in range(8, 504, 1):
            ...
            if np.sum(current_slice_mask) < 5:
                ...
                current_slice_data = data[:, :, z]
                pre_one_data = data[:, :, z - 1]  # previous 1 mm is 1 slices on x-axis_list
