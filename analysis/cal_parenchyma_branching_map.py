...
interval = 2
# if your computer is slow, increase the sample_interval will accelerate sample_interval^3 times
# if sample_interval = 2, one scan need ~6 cpu hours, and the program is well-paralleled.
leave_cpu = 2
...
if __name__ == '__main__':
    ...
    for array_name in array_list:
        ...
        lung = np.load('/home/zhoul0a/Desktop/COVID-19 delta/masks/vessel_mask/' + array_name[:-4] + '.npz')['array']
