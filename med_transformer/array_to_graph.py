...
def interval_connected_analysis(data_array, mask_array=None, interval_list=None, parallel_limit=200, leave_cpu=1):
    ...
    interval_list.append(np.inf)  # add freq new end to the original sample_interval
    ...
    for i in range(0, number_intervals, parallel_limit):
        ...
        print("abstracting mask within sample_interval", i, 'to', i + end_point)
        ...
        print("connect analysis for sample_interval", i, 'to', i + end_point)
        ...
        for j in range(end_point):
            ...
            print("sample_interval", i + j, "has", num_nodes, "nodes")
