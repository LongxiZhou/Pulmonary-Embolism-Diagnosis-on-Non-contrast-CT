import torch
import med_transformer.image_transformer.transformer_for_3D.training_iterations_focal as train_iterations
import os
...
parameters = {
    ...
    "ratio_mask_input": 0.5,  # the ratio masked   0.85 for lung regions,  0.975 for all_file ct
    "ratio_predict": 0.5,  # the ratio to predict  0.15 for lung regions,  0.025 for all_file ct

    "initial_portion": (0, 1),
    "end_portion": (0, 1),
    "ratio_mask_input_end": 0.5,
    "ratio_predict_end": 0.5,

    # prepare dataset (pick samples from lists and form tensors) can be time consuming
    "num_prepared_dataset_train": 3,  # number of prepared dataset during training
    "num_prepared_dataset_test": 3,  # number of prepared dataset during testing, higher the more accuracy, but slower
    "reuse_count": 3,  # number of times each dataset be used

    "tissue_weight_tuple": (3, 1, 1, 1),  # penalty weight for the loss function,
    ...
    "train_data_dir_a": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/blood_vessels/",
    "test_data_dir_a": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/blood_vessels/",

    "train_data_dir_b": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/blood_vessels/",
    "test_data_dir_b": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/blood_vessels/",

    "checkpoint_dir": "/home/zhoul0a/Desktop/pulmonary_embolism/check_point_July/training/lungheart_vessel/",
...
parameters["n_epochs"] = int(parameters["num_interval"] * parameters["interval_epoch"])
...
ct_name_all = os.listdir(parameters["train_data_dir_a"])
