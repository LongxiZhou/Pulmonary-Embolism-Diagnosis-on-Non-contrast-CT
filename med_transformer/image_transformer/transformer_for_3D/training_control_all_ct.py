...
parameters = {
    ...
    "n_epochs": 3000,
    "lr": 1e-4,
    "batch_ct": 2,  # number of ct scans in each batch
    "batch_split": 1,  # each ct scan split into how many samples
    "ratio_mask_input": 0.975,  # the ratio masked   0.85 for lung regions
    "ratio_predict": 0.025,  # the ratio to predict  0.15 for lung regions
    ...
    "train_data_dir": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/all_ct/",
    "test_data_dir": "/home/zhoul0a/Desktop/pulmonary_embolism/dataset_normal_v2/list_pickle_dataset/all_ct/",
    "checkpoint_dir": "/home/zhoul0a/Desktop/pulmonary_embolism/check_points/model_v1/",
