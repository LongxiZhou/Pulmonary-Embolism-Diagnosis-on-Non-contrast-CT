import torch
import med_transformer.image_transformer.transformer_for_3D.training_iterations_v3 as train_iterations
import os
...
parameters = {
    ...
    "ratio_mask_input": 0.9,  # the ratio masked   0.85 for lung regions, 0.9 for lung_heart,  0.975 for all_file ct
    "ratio_predict": 0.9,  # the ratio to predict  0.15 for lung regions, 0.1 for lung_heart,  0.025 for all_file ct
