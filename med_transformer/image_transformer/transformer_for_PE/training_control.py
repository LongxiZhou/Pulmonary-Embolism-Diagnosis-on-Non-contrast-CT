import torch
import med_transformer.image_transformer.transformer_for_PE.training_iteration_balance as train_iterations
import os
...
parameters = {
    ...
    "ratio_mask_input": 0.95,  # the ratio masked   0.85 for lung regions, 0.9 for lung_heart,  0.975 for all_file ct
    "ratio_predict": 0.95,  # the ratio to predict  0.15 for lung regions, 0.1 for lung_heart,  0.025 for all_file ct
    ...
    "input_output_overlap": False,  # whether the query can be a part of the input
    ...
    "decoder_embed_dim": 192,  # the embedding dimension for decoding phase.
    ...
    'num_workers': 4,  # num CPU for the parallel data loading, if you see load average < num_workers, reduce this
    ...
    "train_data_dir":
        "/home/zhoul0a/Desktop/pulmonary_embolism/vessel_dataset_high_resolution_denoise_new/merged_3000_tuple/",
    "test_data_dir":
        "/home/zhoul0a/Desktop/pulmonary_embolism/vessel_dataset_high_resolution_denoise_new/merged_3000_tuple/",

    "checkpoint_dir":
        "/home/zhoul0a/Desktop/pulmonary_embolism/check_point_guide/training/high_resolution_denoise_include_rad/",
