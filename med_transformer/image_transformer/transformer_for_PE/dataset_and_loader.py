...
def extract_sequence(input_tuple):
    ...
    :return: information_sequence, query_gt_sequence
    ...
    query_gt_sequence: same structures as the information, will be extract to gt, guiding mask, locations, etc.
    ...
    if input_output_overlap:
        ...
        for idx in range(length_query_sequence):
            query_gt_sequence.append(content[list_element_index[idx]])
    else:
...
class PreparedDataset:
    ...
    def abstract_batch(self, initial_index, terminal_index):
        return_batch = {"list_sample_sequence": self.prepared_dataset["list_sample_sequence"][
                        ...
                        "list_query_gt_sequence": self.prepared_dataset["list_query_gt_sequence"][
                                                     initial_index: terminal_index]}
        return return_batch
...
class DataLoaderPEIte:
    ...
    def __next__(self):
        ...
        if self.mode == 'test':
            ...
            # return_dict_batch:
            # {"list_sample_sequence":, "list_query_gt_sequence":}
            return return_dict_batch
        # mode == 'train'
        else:
