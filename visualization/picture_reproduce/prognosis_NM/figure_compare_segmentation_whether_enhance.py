...
from basic_tissue_prediction.predict_rescaled import get_top_rated_points_use_lung_as_anchor
...
rescaled_array = np.load('/home/zhoul0a/Desktop/prognosis_project/rescaled_ct_array/xghf-25_2020-07-29.npy')
rescaled_array[0, 0, 308] = -0.5
rescaled_image = np.clip(rescaled_array[:, :, 308] + 0.5, 0, 1)
...
Functions.merge_image_with_mask(rescaled_image, gt_image, save_path='/home/zhoul0a/Desktop/transfer/04_gt_normal.png', high_resolution=True)
...
Functions.merge_image_with_mask(rescaled_image, image_normal_mpu, save_path='/home/zhoul0a/Desktop/transfer/05_mpu_normal.png', high_resolution=True)
...
Functions.merge_image_with_mask(rescaled_image, image_normal_u3d, save_path='/home/zhoul0a/Desktop/transfer/07_3du_normal.png', high_resolution=True)
...
Functions.merge_image_with_mask(rescaled_image, image_normal_ours, save_path='/home/zhoul0a/Desktop/transfer/09_ours_normal.png', high_resolution=True)
...
prob_normal = ours_prob * ours_prob + u3d_prob_normal
mask_normal_ours = get_top_rated_points_use_lung_as_anchor(lung_mask, prob_normal, gt_ratio / 2.5)
image_normal_ours = mask_normal_ours[:, :, 308] * lung_image * (1 - airway_image) * (1 - blood_image)
print(Functions.f1_sore_for_binary_mask(mask_normal_ours, gt))
Functions.merge_image_with_mask(rescaled_image, image_normal_ours, save_path='/home/zhoul0a/Desktop/transfer/11_u2d_normal.png', high_resolution=True)


prob_enhanced = ours_prob * u3d_prob_enhanced + u3d_prob_enhanced
mask_enhanced_ours = get_top_rated_points_use_lung_as_anchor(lung_mask, prob_enhanced, gt_ratio / 1.2)
image_enhanced_ours = mask_enhanced_ours[:, :, 308] * lung_image * (1 - airway_image) * (1 - blood_image) * gt_restrain
print(Functions.f1_sore_for_binary_mask(mask_enhanced_ours, gt))
Functions.merge_image_with_mask(enhanced_image, image_enhanced_ours, save_path='/home/zhoul0a/Desktop/transfer/12_u2d_enhance.png', high_resolution=True)
