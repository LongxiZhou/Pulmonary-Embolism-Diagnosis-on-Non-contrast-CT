...
parameters = {
    ...
    "checkpoint_dir":
        "/data_disk/pulmonary_embolism/segment_clot_on_CTA/check_point/pe_v3/low_resolution_complete_vessel_long/",
    ...
    # set to None if you want to resume previous model's global_bias_range;
    # stable at (0, 0)
