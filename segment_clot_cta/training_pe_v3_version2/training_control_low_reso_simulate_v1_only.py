...
parameters = {
    ...
    "batch_size_test": 4,
    "accumulate_step": 16,  # warm-up usually from 8. Lower the faster, but more risk of model failure
    ...
    "flip_recall": 0.7,  # reach this recall, then can flip
    "flip_precision": 0.7,  # reach this precision, then can flip
    ...
    'min_dice_backup': 0.6,  # reach this dice, model may be saved as backup
