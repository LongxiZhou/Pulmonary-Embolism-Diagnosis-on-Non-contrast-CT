...
if __name__ == '__main__':
    # please modify
    top_dir_models = '/home/chuy/PythonProjects/Pulmonary-Embolism-Diagnosis-on-Non-contrast-CT-main/Data_and_Models'
    label_pickle = Functions.pickle_load_object(os.path.join(top_dir_models, "list_label_augment.pickle"))
    ...
    distribution_list = Functions.pickle_load_object(os.path.join(top_dir_models, 'distribution_non_PE.pickle'))
