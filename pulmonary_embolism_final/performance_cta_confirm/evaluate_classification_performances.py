...
if __name__ == '__main__':
    array_, features_ = form_data_array(name_list_non, name_list_pe, model_type='new_model', augment=True)
    ...
    auc = metrics.roc_auc_score(array_[:, 0], array_[:, feature_column])
    false_positive_rate, true_positive_rate, thresolds = metrics.roc_curve(array_[:, 0], array_[:, feature_column])
