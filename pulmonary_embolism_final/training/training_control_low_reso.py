...
parameters = {
    ...
    "sample_sequence_length": 1500,  # 4000 for high resolution, 1500 for low resolution

    # --------------------------------------------------------
    # training specifics

    "batch_size_simu": 12,  # number of ct in each batch,
    "batch_size_with_gt": 0,
    "relative_ratio_with_gt": 0.5,  # avoid over-fitting
    ...
    "sample_dir_list_non_pe":
        ["/data_disk/pulmonary_embolism_final/training_samples_simulate_clot/"
         "low_resolution/not_pe_ready_not_denoise", ],

    "sample_dir_list_pe":
        ['/data_disk/pulmonary_embolism_final/training_samples_with_annotation/low_resolution/pe_ready_not_denoise', ],

    "sample_interval": (0, 1),
    "shuffle_path_list": True,
    "checkpoint_dir":
        "/data_disk/pulmonary_embolism_final/check_point_dir/low_resolution/warm_up_simulation_only/",
    ...
    "min_clot": 80,  # the volume of clot when applied to vessel like 50 for low resolution, 300 for high resolution
    "power_range": (-0.3, 0.6),
    "add_base_range": (0, 3),
