...
parameters = {
    ...
    "batch_size_simu": 2,  # number of ct in each batch,
    "batch_size_with_gt": 0,
    "relative_ratio_with_gt": 0.25,
    ...
    "accumulate_step": 48,  # real batch size is (batch_simu + batch_with_gt) * accumulate_step
    ...
    "checkpoint_dir":
        "/data_disk/pulmonary_embolism_final/check_point_dir/high_resolution/warm_up_simulation_only/",
