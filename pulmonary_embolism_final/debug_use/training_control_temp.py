...
import torch
import pulmonary_embolism_final.debug_use.training_iterations_temp as train_iterations
import os
...
parameters = {
    ...
    "checkpoint_dir":
        "/data_disk/pulmonary_embolism_final/check_point_dir/high_resolution/temp/",
